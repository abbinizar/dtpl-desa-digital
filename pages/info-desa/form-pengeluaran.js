  ...
  return (
    ...
    <div className="w-full flex justify-center">
      ...
      <div className="shadow-card p-6 space-y-6">
        ...
        <div id="download-template" style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", gap: "10px"}}>
        <p className="text-sm w-full" style={{ width:"150vw"}}>Upload excel Pengeluaran desa sesuai template untuk menampilkan informasi keuangan!</p>
      ...
      <Dialog show={show}>
        <div className="px-8 space-y-4 flex flex-col items-center">
          ...
          Penambahan Pengeluaran Dana Berhasil Disubmit
          </p>  
          <div className="w-6/12 flex justify-center">
            <Button onClick={() => {
              setShow(false);
              router.push("/info-desa/pengeluaran-dana")
            }} isFull label="OK"></Button>
          </div>
        </div>
      </Dialog>
    </div>
